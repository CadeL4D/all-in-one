export const EXTRA_BUILDINGS = {
  arsenal: {name:"Ammunition yard",glyph:"➶",mask:["111","111"],wood:22,stone:12,time:14,hp:140,unlock:"workshop",desc:"Workers bring 2 stone and 1 plank to make 8 shots in 12 working seconds. Carriers deliver ammunition to towers."},
  outpost: {name:"Frontier depot",glyph:"⚑",mask:["111","111","110"],wood:28,stone:20,time:18,hp:230,unlock:"store",desc:"A fortified local warehouse. Adds 80 capacity and wards nearby land. Build beyond the hearth to support rich seams and distant fields."},
...
export const RECIPES = {
  arsenal: {input:{stone:2,planks:1},output:"ammo",amount:8,time:12,target:32,job:"Shaping ammunition"},
