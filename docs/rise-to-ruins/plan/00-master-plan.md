...
Status: **M1 "Village heartbeat" is implemented and playable** at
...
| **M2 — Night & walls** | Corruption spread + 2 monster types, 2 wall tiers + gate, 1 tower, the pathing rule, loss state | Night raids follow RtR pathing rule; maze changes outcomes; loss is readable |
